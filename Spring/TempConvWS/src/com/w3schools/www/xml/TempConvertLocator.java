...
public class TempConvertLocator extends org.apache.axis.client.Service implements com.w3schools.www.xml.TempConvert {
    ...
    private java.lang.String TempConvertSoap_address = "http://www.w3schools.com/xml/tempconvert.asmx";
    ...
    public com.w3schools.www.xml.TempConvertSoap getTempConvertSoap() throws javax.xml.rpc.ServiceException {
    ...
    public com.w3schools.www.xml.TempConvertSoap getTempConvertSoap(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.w3schools.www.xml.TempConvertSoapStub _stub = new com.w3schools.www.xml.TempConvertSoapStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.w3schools.www.xml.TempConvertSoap.class.isAssignableFrom(serviceEndpointInterface)) {
                com.w3schools.www.xml.TempConvertSoapStub _stub = new com.w3schools.www.xml.TempConvertSoapStub(new java.net.URL(TempConvertSoap_address), this);
                _stub.setPortName(getTempConvertSoapWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("https://www.w3schools.com/xml/", "TempConvert");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("https://www.w3schools.com/xml/", "TempConvertSoap"));
        }
